...
<BODY>
	<FORM id="pageForm" name="pageForm"
		...
		<input type="hidden" name="currentPage" id="currentPageInput"
			value="<s:property value="#pageBean.currentPage" />" /> <input
			type="hidden" name="pageSize" id="pageSizeInput"
									...
									<TD height=25>
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													<TD>联系人名称：</TD>
													<TD><INPUT class=textbox style="WIDTH: 80px"
														maxLength=50 name="lkm_name" value="${param['lkm_name']}"></TD>
													<TD>客户名称：</TD>
													<TD><INPUT class=textbox style="WIDTH: 80px"
														maxLength=50 id="cust_name" name="cust_name" value="${param['cust_name']}">
													<INPUT type="hidden" style="WIDTH: 80px"
														maxLength=50 id="cust_id" name="customer.cust_id" value="${param['customer.cust_id']}"></TD>
													<td><input type="button" value="选择客户" onclick="window.open('${pageContext.request.contextPath}/CustomerAction_list?select=true','','width=600,height=300')" />	</td>
											...
											<TBODY>
												...
												<s:iterator value="#pageBean.list" var="linkMan">
													...
													<TR
														...
														<TD><a
															href="${pageContext.request.contextPath }/LinkManAction_edit?lkm_id=<s:property value="#linkMan.lkm_id"/>">修改</a>
															&nbsp;&nbsp; <a
															href="${pageContext.request.contextPath }/LinkManAction_delete?lkm_id=<s:property value="#linkMan.lkm_id"/>">删除</a>
														</TD>
													</TR>
												</s:iterator>
								...
								<TR>
									<TD><SPAN id=pagelink>
											<DIV
												...
												<B>${page}</B> [<A href="javascript:void(0)"

package cn.zilime.domain;

import java.text.SimpleDateFormat;
import java.util.Date;

import cn.zilime.utils.MyUtils;
...
public String getVisit_time_string(){
	return MyUtils.transferDate(visit_time,"yyyy-MM-dd");
}
public String getVisit_nexttime_string(){
	return MyUtils.transferDate(visit_nexttime,"yyyy-MM-dd");
}

...
<head>
<TITLE>
<s:property value="#customer==null?'添加':'修改'" />客户 </TITLE>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		loadSelect("cust_industry.dict_id", "001", "industry"<s:if test="#customer.cust_industry!=null">,<s:property value="#customer.cust_industry.dict_id"/></s:if>);
		loadSelect("cust_level.dict_id", "006", "level"	<s:if test="#customer.cust_level!=null">,<s:property value="#customer.cust_level.dict_id"/></s:if>);
		loadSelect("cust_source.dict_id", "009", "source"<s:if test="#customer.cust_source!=null">,<s:property value="#customer.cust_source.dict_id"/></s:if>);
